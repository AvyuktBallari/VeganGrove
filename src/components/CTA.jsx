const GamblingLossWarning = () => {
  return (
    <div className="mx-auto px-8 font-cute bg-[#e2e8f0] text-[black] py-8 md:py-16 text-center">
      <span className="font-cute border p-4 text-lg rounded-xl mb-5">THE PROBLEM</span> {/* Increased padding and font size */}
